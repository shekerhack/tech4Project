...
public class TwoDimensionalArrays {
    public static void main(String[] args) {
        ...
        String[][] studentGroups = { {"Kaly", "Guluzar", "Melda"}, {"Torrie", "David"}, {"Abe", "Data"}};
        ...
        // How to print all
        System.out.println(Arrays.deepToString(studentGroups)); // deep contents [Kaly, Guluzar, Melda], [Torrie, David], [Abe, Data]
