package exceptions.cutom_exception;
  ...
  /*
    ...
    */
    ...
    public static void checkIn(int day){
        if(day == 1 || day == 7) System.out.println("User is allowed to check in from 10Am to 3PM");
        if (day == 2) System.out.println("User is allowed to check in from 10Am to 5PM");
    ...
    public static void checkIn2(int day){
        switch (day){
            case 1:
            case 7:
                System.out.println("User is allowed to check in 10AM to 3PM");
                break;
            case 2:
            case 3:
            case 4:
