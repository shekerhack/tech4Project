...
public class _02_concat {
    public static void main(String[] args) {
        ...
        -It is a return type method, and it returns a new String that is the combination of the others, which means concat
        ...
        System.out.println("Hello".concat(" World!")); // Hello Wold!
