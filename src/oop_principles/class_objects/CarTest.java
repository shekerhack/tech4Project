...
public class CarTest {
    public static void main(String[] args) {
        ...
        Car car1 = new Car();
        System.out.println(car1); // oop_principles.class_objects.Car@1d251891
       ...
       // car1.color = "Red";
        ...
        System.out.println(car1.make); // null- this is default value // Tesla
        System.out.println(car1.model); // null // S
        System.out.println(car1.year); // 0 // 2022
        System.out.println(car1.color); // null // Red
