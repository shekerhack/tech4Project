...
public class HashMapPractice {
    public static void main(String[] args) {
        ...
        System.out.println(capitals.get("Lisbon")); // null because you cannot key with value
        ...
        students.put(1, "Sheker"); // replaced Alona with Sheker
        students.put(5, null);
        students.put(6, null);
        students.put(7, null);
        students.put(null, null); // Alex replaced with null
